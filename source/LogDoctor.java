...
/**GUI que nos permite realizar inicio de sesión como médico
 *
...
public class LogDoctor extends javax.swing.JFrame {
     ...
     * Crea un nuevo formulario LogDoctor
     */
    public LogDoctor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Inicia Sesión como Doctor");
    ...
    private void forgot_passActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_forgot_passActionPerformed
        ...
        if(!identificacion.isEmpty())
        {
            ...
            dispose();
            // crear una instancia del GUI que nos permite cambiar la contraseña del médico
            ForgotPwdDoctor change_pwd = new ForgotPwdDoctor(identificacion);
            // remover los objetos por defecto del encasillado de especialidades
            change_pwd.especialidad.removeAllItems();
            ...
            try
            {
                ...
                String query = "select Especialidad from MedExpress.Especialidades";
                ...
                while(result.next())
                {
                    // extraer el resultado y enviar la información al encasillado de las especialidades en el GUI nuevo
                    change_pwd.especialidad.addItem(result.getString(1));
                }
        ...
        {
            JOptionPane.showMessageDialog(null, "Favor de al menos llenar el ID del médico.");
        }
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        {
            coneccion = DriverManager.getConnection("jdbc:mysql://localhost:3306/MedExpress?autoReconnect=true&useSSL=false",DBUSER,YOURPASSWORD);
            // query para extraer la información del médico
            String query = "select Pwd, Nombre, Apellidos from MedExpress.Medicos where ID_Medico ='" + identificacion +"'";
            Statement statement = coneccion.createStatement();
            ResultSet result = statement.executeQuery(query);
            ...
            while(result.next())
            {
                ...
                if(password.equals(pass))
                {
                    ...
                    // cerrar el GUI actual
                    dispose();
                    // crear una instancia del GUI que nos permite mostrar el menú principal del médico
                    DoctorUserForm medico = new  DoctorUserForm(identificacion);
                    // establecer el mensaje de bienvenida en el nuevo GUI
                    medico.welcome.setText("<html>¿Qué desea hacer Dr.<BR>" + fullName + "?");
            ...
            if(!result.next())
            {//no consiguió a alguien con el ID de médico indicado
                error.setText("<html>El  ID de médico o la contraseña indicada es incorrecta.");
             }
